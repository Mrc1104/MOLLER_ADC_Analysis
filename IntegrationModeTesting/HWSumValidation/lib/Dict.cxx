...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::tDataSamples*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("tDataSamples", ::tDataSamples::Class_Version(), "DataSmpl.h", 9,
...
namespace ROOT {
   static void *new_tDataIntegration(void *p = nullptr);
   static void *newArray_tDataIntegration(Long_t size, void *p);
   static void delete_tDataIntegration(void *p);
   static void deleteArray_tDataIntegration(void *p);
   static void destruct_tDataIntegration(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::tDataIntegration*)
   {
      ::tDataIntegration *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::tDataIntegration >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("tDataIntegration", ::tDataIntegration::Class_Version(), "DataSmpl.h", 47,
                  typeid(::tDataIntegration), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::tDataIntegration::Dictionary, isa_proxy, 4,
                  sizeof(::tDataIntegration) );
      instance.SetNew(&new_tDataIntegration);
      instance.SetNewArray(&newArray_tDataIntegration);
      instance.SetDelete(&delete_tDataIntegration);
      instance.SetDeleteArray(&deleteArray_tDataIntegration);
      instance.SetDestructor(&destruct_tDataIntegration);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::tDataIntegration*)
   {
      return GenerateInitInstanceLocal(static_cast<::tDataIntegration*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::tDataIntegration*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr tDataIntegration::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *tDataIntegration::Class_Name()
{
   return "tDataIntegration";
}

//______________________________________________________________________________
const char *tDataIntegration::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::tDataIntegration*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int tDataIntegration::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::tDataIntegration*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *tDataIntegration::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::tDataIntegration*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *tDataIntegration::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::tDataIntegration*)nullptr)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void tDataIntegration::Streamer(TBuffer &R__b)
{
   // Stream an object of class tDataIntegration.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(tDataIntegration::Class(),this);
   } else {
      R__b.WriteClassBuffer(tDataIntegration::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_tDataIntegration(void *p) {
      return  p ? new(p) ::tDataIntegration : new ::tDataIntegration;
   }
   static void *newArray_tDataIntegration(Long_t nElements, void *p) {
      return p ? new(p) ::tDataIntegration[nElements] : new ::tDataIntegration[nElements];
   }
   // Wrapper around operator delete
   static void delete_tDataIntegration(void *p) {
      delete (static_cast<::tDataIntegration*>(p));
   }
   static void deleteArray_tDataIntegration(void *p) {
      delete [] (static_cast<::tDataIntegration*>(p));
   }
   static void destruct_tDataIntegration(void *p) {
      typedef ::tDataIntegration current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::tDataIntegration
...
"/home/mrc/Documents/coda3-decoder/",
nullptr
    };
...
class __attribute__((annotate("$clingAutoload$DataSmpl.h")))  __attribute__((annotate("$clingAutoload$StreamingDecode.h")))  tDataIntegration;
)DICTFWDDCLS";
